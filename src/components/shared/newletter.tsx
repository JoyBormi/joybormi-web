...
type NewLetterProps = { className?: string }

const NewLetter: React.FC<NewLetterProps> = ({ className }) => {
  return (
    <div className={cn("bg-indigo-700 py-16 sm:py-24 lg:py-32", className)}>
        ...
        <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
          <div className="flex gap-x-4">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="min-w-0 flex-auto rounded-md border-0 bg-white/10 px-3.5 py-2 text-white shadow-sm ring-1 ring-white/10 ring-inset placeholder:text-white/75 focus:ring-2 focus:ring-white focus:ring-inset sm:text-sm sm:leading-6"
